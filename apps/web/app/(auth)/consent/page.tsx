...
export default async function ConsentPage() {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-50 to-teal-50 px-4 py-12">
      <div className="w-full max-w-lg rounded-2xl border border-ink-200 bg-white p-8 shadow-sm">
        ...
        <form action={signOutAction}>
          <button
            type="submit"
            className="mt-3 w-full rounded-lg border border-ink-200 bg-white px-4 py-2.5 text-sm font-semibold text-ink-700 shadow-sm transition-colors hover:bg-ink-50"
          >
            Not now — sign out
          </button>
        </form>
